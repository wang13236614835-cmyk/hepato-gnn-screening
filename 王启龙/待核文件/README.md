...
├── 王启龙/ 宁显泷/ 衣思淼/ 代维斯丹/ 王散曼/   # 一级按人：各含 工作台.md(任务/记录)＋打卡_姓名.html(学习/打卡)＋待核文件/(名下要核验的具体文件快照+清单)
...
|---|---|---|---|
| 王启龙 | 仓库/环境/一键运行、适用域预警集成、结果自动化 | 辅助/工程（L1–L5·90文件） | [王启龙/工作台.md](王启龙/工作台.md) ＋ [打卡](王启龙/打卡_王启龙.html) |
| 宁显泷 | SMILES→图解析、GNN+MC Dropout、损失权重选择 | 代码验证（N1–N6·12文件） | [宁显泷/工作台.md](宁显泷/工作台.md) ＋ [打卡](宁显泷/打卡_宁显泷.html) |
| 衣思淼 | 数据清洗/骨架划分/适用域边界、协同评分融合 | 数据线A（Y1–Y6·14文件） | [衣思淼/工作台.md](衣思淼/工作台.md) ＋ [打卡](衣思淼/打卡_衣思淼.html) |
| 代维斯丹 | 对接流程/网格盒子、传统基准线、可靠性评估 | 数据线B（D1–D5·18文件） | [代维斯丹/工作台.md](代维斯丹/工作台.md) ＋ [打卡](代维斯丹/打卡_代维斯丹.html) |
| 王散曼 | 数据库调研、候选池构建、文献支撑库 | 文献（M1–M4·4文件） | [王散曼/工作台.md](王散曼/工作台.md) ＋ [打卡](王散曼/打卡_王散曼.html) |
...
`<姓名>/打卡_<姓名>.html` 学习、打卡、生成周报。
**打卡页怎么打开**：git clone 或 Download ZIP 到本地后**浏览器双击**（页面互相能跳转；

...
> **参考(2026-09-03)**:有人用另建的同类管线(Vina 1.2.7+RDKit/meeko,非本项目代码)
> 试跑了 144 次真实对接,证明该流程类型可行并留下参数与坑位记录
> (`results/docking/real/README.md`);**本项目 WP2 的全部步骤(自家受体/配体准备、
> 60 候选 × 1OSH/2FLU、run_vina.sh 与日志汇总脚本)仍按下文原样执行,一步未减**。

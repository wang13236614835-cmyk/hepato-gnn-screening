...
TARGETS = {
    "FXR_LBD": {
        ...
        "evidence": {
            ...
            "安全": "奥贝胆酸曾获FDA批准用于PBC，但批准已于2025-11-24撤回；不能作为当前一般保肝安全性背书。来源 https://www.govinfo.gov/content/pkg/FR-2025-11-24/pdf/2025-20767.pdf",
        },
    ...
    "KEAP1_KELCH": {
        ...
        "evidence": {
            ...
            "表达": "全身广泛表达, 肝内含量高",
            "安全": "其他机制的Nrf2相关药物不能替代直接Kelch抑制剂的安全证据；具体临床阶段待逐项来源核对",
        },
        "pocket_type": "polar",
    },
}

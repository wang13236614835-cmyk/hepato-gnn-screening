...
> 一句话：**每个人从这里进入项目**——你是谁、核验什么任务、名下哪些文件、
> 学习线怎么走、打卡页在哪、怎么操作，全部按全名分节，互不交叉。
> 任务数据源 `docs/VERIFY_TASKS.md`；文件映射见其附录A；操作手册
> `docs/VERIFY_MANUAL.md`；打卡页在 `tools/学期推进流_*.html`（浏览器打开）。

## 全队速查表

| 成员 | 角色 | 校验线 | 任务编号 | 名下文件 | 分项时限 | 打卡页（tools/） |
|---|---|---|---|---|---|---|
| 王启龙 | 负责人·工程支撑 | 辅助/工程（A2） | L1–L5 | 90 | 09-20 | 学期推进流_王启龙.html |
| 宁显泷 | 算法 | 代码验证（A1） | N1–N6 | 12 | 09-13 | 学期推进流_宁显泷.html |
| 衣思淼 | 数据 | 数据线A：数据集与排名（A3） | Y1–Y6 | 14 | 09-13 | 学期推进流_衣思淼.html |
| 代维斯丹 | 验证 | 数据线B：对接·指纹·图（A4） | D1–D5 | 18 | 09-13 | 学期推进流_代维斯丹.html |
| 王散曼 | 文献 | 文献（A5） | M1–M4 | 4 | 09-20 | 学期推进流_王散曼.html |
